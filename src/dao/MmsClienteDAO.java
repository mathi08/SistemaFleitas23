 ...
 * @author u07875284120
 */
public class MmsClienteDAO extends DAO_Abstract {
    ...
    public Object list(int id) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(MmsClienteDAO.class); //importar do bean e do hibernate; criteria é pra fazer select * from na O.O
