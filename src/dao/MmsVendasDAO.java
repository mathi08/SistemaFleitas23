 ...
 * @author u07875284120
 */
public class MmsVendasDAO extends DAO_Abstract {
    ...
    public Object list(int id) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(MmsVendasDAO.class); //importar do bean e do hibernate; criteria é pra fazer select * from na O.O
